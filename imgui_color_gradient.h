...
//  imgui extension
//
//  Created by David Gallardo on 11/06/16. (Modified for Dymatic)
...
bool GradientEditor(const char*      label,
                    ImGradient*      gradient,
                    ImGradientMark*& draggingMark,
                    ImGradientMark*& selectedMark);

//bool Gradient(const char* label, ImGradient*, ImGradientMark*&, ImGradientMark*&) { return false; }
