...
namespace ImGui
{
    ...
    IMGUI_API void          TextDisabledUnformatted(const char* text, const char* text_end = NULL);
...
enum ImGuiCol_
{
    ...
    ImGuiCol_ScrollbarDots,
    ImGuiCol_ButtonToggled,
    ImGuiCol_ButtonToggledHovered,
    ImGuiCol_ProgressBarBg,
    ImGuiCol_ProgressBarBorder,
    ...
    ImGuiCol_TextEditorFlowControlKeyword,
    ImGuiCol_TextEditorStorageKeyword,
    ImGuiCol_TextEditorPrimitiveKeyword,
    ImGuiCol_TextEditorVectorKeyword,
    ImGuiCol_TextEditorMatrixKeyword,
    ImGuiCol_TextEditorTextureKeyword,
    ImGuiCol_TextEditorQualifierKeyword,
    ImGuiCol_TextEditorFunction,
    ImGuiCol_TextEditorNumber,
    ImGuiCol_TextEditorBoolean,
    ImGuiCol_TextEditorString,
    ImGuiCol_TextEditorCharLiteral,
    ImGuiCol_TextEditorComponent,
...
struct ImGuiIO
{
    ...
    const char* InfinityString;                 // = "inf"          // The string used to represent infinity for floating point values.
    const char* NegativeInfinityString;         // = "-inf"         // The string used to represent negative infinity for floating point values.
